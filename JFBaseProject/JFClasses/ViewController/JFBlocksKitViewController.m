...
#import "JFBlocksKitViewController.h"

@interface JFBlocksKitViewController ()<UIAlertViewDelegate>
/** 红色按钮,左20,上80,宽高100,50,点击后打印 'aaa'*/
@property(nonatomic,strong) UIButton *redBtn;
/** 蓝色按钮,右20,上80,宽高与红色按钮一样,点击后弹出提示框*/
@property(nonatomic,strong) UIButton *blueBtn;
@end

@implementation JFBlocksKitViewController
- (void)viewDidLoad {
    [super viewDidLoad];
